 ...
 */
public class AndroidInstrumentator implements IInstrumentator {
	...
	public void startApp() {
		...
		// capabilities.setCapability("automationName", "UiAutomator2"); // This is explored but doesn't work
		...
		try {
			...
			System.out.println("Exception in AndroidInstrumentator:startApp");
...
//			driver.quit();
	...
	public String tryToClick(WebElement we) {
		...
		try {
//			System.out.println("In try to click!!!!! Displaed and enabled: " + we.isDisplayed() + " "  + we.isEnabled() );
